...
async def benchmark(
    ...
    await print_and_save_result(args, benchmark_duration, prompts_sent, "weighted",
    ...
    for model, data in per_model_results.items():
        await print_and_save_result(args, benchmark_duration, len(data["latencies"]), model,
...
async def print_and_save_result(args: argparse.Namespace, benchmark_duration, total_requests, model, request_latencies, ttfts, itls, tpots, errors):
  benchmark_result = {}
